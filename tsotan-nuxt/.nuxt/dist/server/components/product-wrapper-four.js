...
/* harmony default export */ var ProductWrapperFourvue_type_script_lang_js_ = ({components:{ProductGridStyleThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 84)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57))},computed:{products(){return this.$store.getters.getProducts;}}});
...
installComponents(component, {ProductGridStyleThree: __webpack_require__(84).default,QuickView: __webpack_require__(57).default})
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/product/ProductGridStyleThree.vue?vue&type=template&id=38b6edd6&
var render=function render(){var _vm=this,_c=_vm._self._c;return _c('div',{staticClass:"product-wrap-3 mb-20"},[_vm._ssrNode("<div class=\"product-img\">","</div>",[_c('n-link',{attrs:{"to":`/product/${_vm.slugify(_vm.product.title)}`}},[_c('img',{staticClass:"default-img",attrs:{"src":_vm.product.images[0],"alt":_vm.product.title}})]),_vm._ssrNode(" <div class=\"product-badges\">"+(_vm.product.isNew?"<span class=\"product-label pink\">New</span>":"<!---->")+" "+(_vm.product.discount?"<span class=\"product-label purple\">"+_vm._ssrEscape("-"+_vm._s(_vm.product.discount)+"%")+"</span>":"<!---->")+"</div> "),_vm._ssrNode("<div class=\"product-content-3-wrap\">","</div>",[_vm._ssrNode("<div class=\"product-content-3\">","</div>",[_vm._ssrNode("<div class=\"product-title\">","</div>",[_vm._ssrNode("<h3>","</h3>",[_c('n-link',{attrs:{"to":`/product/${_vm.slugify(_vm.product.title)}`}},[_vm._v(_vm._s(_vm.product.title))])],1)]),_vm._ssrNode(" <div class=\"price-3\"><span>"+_vm._ssrEscape("$"+_vm._s(_vm.discountedPrice(_vm.product).toFixed(2)))+"</span> "+(_vm.product.discount>0?"<span class=\"old\">"+_vm._ssrEscape("$"+_vm._s(_vm.product.price.toFixed(2)))+"</span>":"<!---->")+"</div> <div class=\"product-action-3\"><button title=\"Compare\" class=\"btn\"><i class=\"pe-7s-shuffle\"></i></button> <button title=\"Add To Cart\" class=\"btn\"><i class=\"pe-7s-cart\"></i></button> <button title=\"Wishlist\" class=\"btn\"><i class=\"pe-7s-like\"></i></button> <button title=\"Quick View\" class=\"btn\"><i class=\"pe-7s-look\"></i></button></div>")],2)])],2)]);};var staticRenderFns=[];
// CONCATENATED MODULE: ./components/product/ProductGridStyleThree.vue?vue&type=template&id=38b6edd6&
