...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/product/ProductNewWrapper.vue?vue&type=template&id=45fb808a&
...
// CONCATENATED MODULE: ./components/product/ProductNewWrapper.vue?vue&type=template&id=45fb808a&
...
/* harmony default export */ var ProductNewWrappervue_type_script_lang_js_ = ({components:{ProductGridItemTwo:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 58)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57))},data(){return{swiperOption:{loop:true,speed:750,spaceBetween:30,slidesPerView:4,autoplay:{delay:6000},navigation:{nextEl:'.swiper-button-next',prevEl:'.swiper-button-prev'},breakpoints:{320:{slidesPerView:1},480:{slidesPerView:2},768:{slidesPerView:3},992:{slidesPerView:4}}}};},computed:{products(){return this.$store.getters.getNewProducts;}}});
