...
/* harmony default export */ var ProductWrappervue_type_script_lang_js_ = ({props:['isSectionTitle'],components:{ProductGridItem:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 60)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 55))},computed:{newProducts(){return this.$store.getters.getNewProducts;},bestProducts(){return this.$store.getters.getBestProducts;},saleProducts(){return this.$store.getters.getSaleProducts;}},data(){return{layout:"twoColumn"};}});
...
installComponents(component, {ProductGridItem: __webpack_require__(60).default,QuickView: __webpack_require__(55).default})
