...
/* harmony default export */ var ProductWrappervue_type_script_lang_js_ = ({props:['isSectionTitle'],components:{ProductGridItem:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 61)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 57))},computed:{newProducts(){return this.$store.getters.getNewProducts;},bestProducts(){return this.$store.getters.getBestProducts;},saleProducts(){return this.$store.getters.getSaleProducts;}},data(){return{layout:"twoColumn"};}});
...
installComponents(component, {ProductGridItem: __webpack_require__(61).default,QuickView: __webpack_require__(57).default})
