...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/blog-right-sidebar.vue?vue&type=template&id=7a55988f&
...
// CONCATENATED MODULE: ./pages/blog/blog-right-sidebar.vue?vue&type=template&id=7a55988f&
...
/* harmony default export */ var blog_right_sidebarvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 52)),BlogItemStyleTwo:()=>__webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, 113)),BlogSidebar:()=>__webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 114)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},data(){return{blogData: blog,currentPage:1,perPage:6};},computed:{getItems(){let start=(this.currentPage-1)*this.perPage;let end=this.currentPage*this.perPage;return this.blogData.slice(start,end);},getPaginateCount(){return Math.ceil(this.blogData.length/this.perPage);}},methods:{paginateClickCallback(page){this.currentPage=Number(page);}},head(){return{title:"Blog Right Sidebar"};}});
