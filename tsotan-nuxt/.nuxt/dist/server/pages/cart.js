...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/cart.vue?vue&type=template&id=6a0cc68b&
var render=function render(){var _vm=this,_c=_vm._self._c;return _c('div',{staticClass:"cart-page-wrapper"},[_c('HeaderWithTopbar',{attrs:{"containerClass":"container"}}),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"pageTitle":"Барааны Сагс"}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"cart-main-area pt-90 pb-100\">","</div>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm.products.length>0?_vm._ssrNode("<div class=\"col-12\">","</div>",[_vm._ssrNode("<h3 class=\"cart-page-title\">Таны картанд байгаа бараанууд</h3> "),_vm._ssrNode("<div class=\"table-content table-responsive cart-table-content\">","</div>",[_vm._ssrNode("<table>","</table>",[_vm._ssrNode("<thead><tr><th>Зураг</th> <th>Нэр</th> <th>Үнэ</th> <th>Тоо Хэмжээ</th> <th>Нийт үнэ</th> <th>Үйлдэл</th></tr></thead> "),_vm._ssrNode("<tbody>","</tbody>",_vm._l(_vm.products,function(product,index){return _vm._ssrNode("<tr>","</tr>",[_vm._ssrNode("<td class=\"product-thumbnail\">","</td>",[_c('n-link',{attrs:{"to":`/product/${_vm.slugify(product.title)}`}},[_c('img',{attrs:{"src":product.img1,"alt":product.title}})])],1),_vm._ssrNode(" "),_vm._ssrNode("<td class=\"product-name\">","</td>",[_c('n-link',{attrs:{"to":`/product/${_vm.slugify(product.title)}`}},[_vm._v(_vm._s(product.title))])],1),_vm._ssrNode(" <td class=\"product-price-cart\"><span class=\"amount\">"+_vm._ssrEscape("$"+_vm._s(_vm.discountedPrice(product).toFixed(2)))+"</span> <del class=\"old\">"+_vm._ssrEscape("$"+_vm._s(product.price.toFixed(2)))+"</del></td> <td class=\"product-quantity\"><div class=\"cart-plus-minus\"><button class=\"dec qtybutton\">-</button> <input type=\"text\" readonly=\"readonly\""+_vm._ssrAttr("value",product.cartQuantity)+" class=\"cart-plus-minus-box\"> <button class=\"inc qtybutton\">+</button></div></td> <td class=\"product-subtotal\">"+_vm._ssrEscape("$"+_vm._s(product.total.toFixed(2)))+"</td> <td class=\"product-remove\"><button><i class=\"fa fa-times\"></i></button></td>")],2);}),0)],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-12\">","</div>",[_vm._ssrNode("<div class=\"cart-shiping-update-wrapper\">","</div>",[_vm._ssrNode("<div class=\"cart-shiping-update\">","</div>",[_c('n-link',{attrs:{"to":"/shop"}},[_vm._v("Үргэлжлүүлэх")])],1),_vm._ssrNode(" <div class=\"cart-clear\"><button>Картыг хоослох</button></div>")],2)])]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-4 col-md-12\">","</div>",[_vm._ssrNode("<div class=\"grand-total\">","</div>",[_vm._ssrNode("<div class=\"title-wrap\"><h4 class=\"cart-bottom-title section-bg-gary-cart\">Сагс</h4></div> <h5>Нийт бүтээгдэхүүн<span>"+_vm._ssrEscape("$"+_vm._s(_vm.total.toFixed(2)))+"</span></h5> <h4 class=\"grand-total-title\">Нийт үнэ<span>"+_vm._ssrEscape("$"+_vm._s(_vm.total.toFixed(2)))+"</span></h4> "),_c('n-link',{attrs:{"to":"/checkout"}},[_vm._v("Төлбөр төлөх")])],2)])])],2):_vm._ssrNode("<div class=\"col-12\">","</div>",[_vm._ssrNode("<div class=\"empty-cart text-center\">","</div>",[_vm._ssrNode("<div class=\"icon\"><i class=\"pe-7s-cart\"></i></div> <h4>Сагсанд бараа алга байна</h4> "),_c('n-link',{staticClass:"empty-cart__button",attrs:{"to":"/shop"}},[_vm._v("Дэлгүүр")])],2)])])])]),_vm._ssrNode(" "),_c('TheFooter')],2);};var staticRenderFns=[];
// CONCATENATED MODULE: ./pages/cart.vue?vue&type=template&id=6a0cc68b&
...
/* harmony default export */ var cartvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 52)),Breadcrumb:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 56)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 53))},data(){return{singleQuantity:1};},computed:{products(){return this.$store.getters.getCart;},total(){return this.$store.getters.getTotal;}},methods:{incrementProduct(product){const prod={...product,cartQuantity:1};if(product.cartQuantity<product.quantity){this.$store.dispatch('addToCartItem',prod);}},decrementProduct(product){const prod={...product,cartQuantity:1};if(product.cartQuantity>1){this.$store.dispatch('decreaseProduct',prod);}},removeProduct(product){// for notification
this.$notify({title:'Item remove from cart!'});this.$store.dispatch('removeProductFromCart',product);},discountedPrice(product){return product.price;},clearCart(){if(confirm("Are you sure you want to clear cart")){// for notification
this.$notify({title:'Item remove from cart!'});this.$store.commit('CLEAR_CART');}},slugify(text){return String(text)// .toString()
