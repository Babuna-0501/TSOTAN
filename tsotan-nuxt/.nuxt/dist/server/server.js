...
/******/ 			var chunk = require("./" + ({"0":"components/unused-blog-item-style-two","1":"components/unused-blog-sidebar","2":"components/facebook-chatbox","3":"components/unused-ad","4":"components/unused-blog-item","5":"components/unused-blog-wrapper","6":"components/unused-brand-logo-carousel","8":"components/banner-item","9":"components/banner-style-five","10":"components/banner-style-four","11":"components/banner-style-one","12":"components/banner-style-six","13":"components/banner-style-three","14":"components/banner-style-two","15":"components/breadcrumb","16":"components/contact-info","17":"components/deal-with-countdown","18":"components/deal-with-countdown-two","19":"components/facebook","20":"components/footer-style-two","21":"components/form-page","22":"components/header-logo-center-with-transparent","23":"components/header-offcanvas-menu-with-transparent","24":"components/header-with-top-bar-two","25":"components/header-with-topbar","26":"components/hero-slider","27":"components/hero-slider-tsotan","28":"components/login","29":"components/policy-service-policy","30":"components/policy-service-policy-five","31":"components/policy-service-policy-four","32":"components/policy-service-policy-three","33":"components/policy-service-policy-two","34":"components/product-details-wrapper","35":"components/product-grid-item","36":"components/product-grid-item-two","37":"components/product-grid-style-three","38":"components/product-new-wrapper","39":"components/product-payment-timer","40":"components/product-wrapper","41":"components/product-wrapper-books","42":"components/product-wrapper-cosmetics","43":"components/product-wrapper-five","44":"components/product-wrapper-four","45":"components/product-wrapper-seven","46":"components/product-wrapper-three","47":"components/product-wrapper-tsotan","48":"components/product-wrapper-two","49":"components/quick-view","50":"components/shop-sidebar","51":"components/the-footer","52":"components/the-header","53":"components/unused-about-mission","54":"components/unused-fun-fact","55":"components/unused-instagram-post-wrapper","56":"components/unused-newsletter-style-one","57":"components/unused-product-details-description-review","58":"components/unused-register","59":"components/unused-section-title-with-sub-title","60":"components/unused-team-members","61":"components/unused-testimonial-one","62":"components/unused-welcome-message","63":"pages/blog/_slug","64":"pages/blog/blog-right-sidebar","65":"pages/blog/blog-without-sidebar","66":"pages/blog/index","67":"pages/cart","68":"pages/checkout","69":"pages/confirmation","70":"pages/contact","71":"pages/index","72":"pages/my-account","73":"pages/product/product-detail/_slug","74":"pages/shop","75":"pages/shop-new"}[chunkId]||chunkId) + ".js");
...
const url="https://rest.tsotan.mn";/* harmony default export */ __webpack_exports__["a"] = ({async createProduct(data){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${url}/product/create-with-img`,data);// return axios.post(`${url}/product/create-with-img`, data);
},async updateProduct(id,data){// return axios.post(`${url}/product/update/${id}`, data,  {headers: {'Content-Type': 'multipart/form-data'}});
return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${url}/product/update/${id}`,data);},async getProductList(id){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`${url}/product/list/${id}`);},async view(id){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`${url}/product/view/${id}`);},async detail(id){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`${url}/product/detail/${id}`);},async deleteProduct(id){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.delete(`${url}/product/delete/${id}`);},async getCategories(){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`${url}/category/list-names`);},async getCategoriesByParent(id){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(`${url}/category/list/${id}`);},async createOrder(data){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${url}/order/create`,data);},async createInvoice(data){return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(`${url}/order/qpay-invoice`,data);}});
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/MiniCart.vue?vue&type=template&id=799962e3&
var render=function render(){var _vm=this,_c=_vm._self._c;return _c('client-only',[_c('div',{staticClass:"minicart-wrapper",class:_vm.miniCart},[_vm.products.length>0?_c('div',{staticClass:"shopping-cart-content"},[_c('ul',_vm._l(_vm.products,function(product,index){return _c('li',{key:index,staticClass:"single-shopping-cart"},[_c('div',{staticClass:"shopping-cart-img"},[_c('img',{attrs:{"src":product.img,"alt":product.name},on:{"click":function($event){return _vm.onClick(product.id);}}})]),_vm._v(" "),_c('div',{staticClass:"shopping-cart-title"},[_c('h4',[_c('div',{on:{"click":function($event){return _vm.onClick(product.id);}}},[_vm._v(_vm._s(product.name))])]),_vm._v(" "),_c('h6',[_vm._v("Тоо : "+_vm._s(product.cartQuantity))]),_vm._v(" "),_c('span',[_vm._v(_vm._s(product.price))])]),_vm._v(" "),_c('div',{staticClass:"shopping-cart-delete"},[_c('button',{on:{"click":function($event){return _vm.removeProduct(product);}}},[_c('i',{staticClass:"fa fa-times-circle"})])])]);}),0),_vm._v(" "),_c('div',{staticClass:"shopping-cart-total"},[_c('h4',[_vm._v("\n          Нийт : "),_c('span',{staticClass:"shop-total"},[_vm._v(_vm._s(_vm.total.toFixed(2))+"₮")])])]),_vm._v(" "),_c('div',{staticClass:"shopping-cart-btn btn-hover text-center",on:{"click":function($event){return _vm.$emit('minicartClose');}}},[_c('n-link',{staticClass:"default-btn",attrs:{"to":"/cart"}},[_vm._v("Сагсыг харах")]),_vm._v(" "),_c('n-link',{staticClass:"default-btn",attrs:{"to":"/checkout"}},[_vm._v("төлбөрийн хэсэг")])],1)]):_c('div',{staticClass:"shopping-cart-content text-center"},[_c('p',[_vm._v("Сагсанд бараа байхгүй байна")])])])]);};var staticRenderFns=[];
// CONCATENATED MODULE: ./components/MiniCart.vue?vue&type=template&id=799962e3&
...
/* harmony default export */ var MiniCartvue_type_script_lang_js_ = ({props:["miniCart"],computed:{products(){return this.$store.getters.getCart;},total(){return this.$store.getters.getTotal;}},methods:{async onClick(id){console.log("mini cart onClick");try{const product=await this.getDetail(id);console.log(product);this.$modal.show("quickview",product);}catch(error){console.error("Error fetching product details:",error);}},async getDetail(id){try{const res=await product["a" /* default */].detail(id);console.log(res.data);return res.data;}catch(error){console.error("Error fetching product details:",error);throw error;}},removeProduct(product){// for notification
...
/* harmony default export */ var OffCanvasMobileMenuvue_type_script_lang_js_ = ({components:{ResponsiveMobileMenu:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 33))}});
...
installComponents(component, {ResponsiveMobileMenu: __webpack_require__(33).default})
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Navigation.vue?vue&type=template&id=4ea47b26&
var render=function render(){var _vm=this,_c=_vm._self._c;return _c('ul',[_vm._ssrNode("<li>","</li>",[_c('n-link',{attrs:{"to":"/shop-new"}},[_vm._v("Шинэ бараа"),_c('i')])],1),_vm._ssrNode(" "),_vm._ssrNode("<li>","</li>",[_c('n-link',{attrs:{"to":"/shop"}},[_vm._v("Бүтээгдэхүүн")])],1),_vm._ssrNode(" "),_vm._ssrNode("<li>","</li>",[_c('n-link',{attrs:{"to":"/#service"}},[_vm._v(" Үйлчилгээ"),_c('i')])],1),_vm._ssrNode(" "),_vm._ssrNode("<li>","</li>",[_c('n-link',{attrs:{"to":"/#social"}},[_vm._v("Сошиал")])],1),_vm._ssrNode(" "),_vm._ssrNode("<li>","</li>",[_c('n-link',{attrs:{"to":"/contact"}},[_vm._v("Холбоо барих ")])],1)],2);};var staticRenderFns=[];
// CONCATENATED MODULE: ./components/Navigation.vue?vue&type=template&id=4ea47b26&
...
__webpack_require__.d(components_namespaceObject, "FacebookChatbox", function() { return FacebookChatbox; });
__webpack_require__.d(components_namespaceObject, "FooterStyleTwo", function() { return FooterStyleTwo; });
__webpack_require__.d(components_namespaceObject, "FormPage", function() { return FormPage; });
...
__webpack_require__.d(components_namespaceObject, "ProductPaymentTimer", function() { return ProductPaymentTimer; });
...
__webpack_require__.d(components_namespaceObject, "UnusedAd", function() { return UnusedAd; });
...
const _0c7eb1ab=()=>interopDefault(__webpack_require__.e(/* import() | pages/blog/index */ 66).then(__webpack_require__.bind(null, 102)));const _618ee916=()=>interopDefault(__webpack_require__.e(/* import() | pages/cart */ 67).then(__webpack_require__.bind(null, 103)));const _41acb41b=()=>interopDefault(__webpack_require__.e(/* import() | pages/checkout */ 68).then(__webpack_require__.bind(null, 104)));const _6128fd0a=()=>interopDefault(__webpack_require__.e(/* import() | pages/confirmation */ 69).then(__webpack_require__.bind(null, 101)));const _0d28b84a=()=>interopDefault(__webpack_require__.e(/* import() | pages/contact */ 70).then(__webpack_require__.bind(null, 105)));const _11bf70be=()=>interopDefault(__webpack_require__.e(/* import() | pages/my-account */ 72).then(__webpack_require__.bind(null, 106)));const _8b7fdf6a=()=>interopDefault(__webpack_require__.e(/* import() | pages/shop */ 74).then(__webpack_require__.bind(null, 107)));const _568cbb9e=()=>interopDefault(__webpack_require__.e(/* import() | pages/shop-new */ 75).then(__webpack_require__.bind(null, 108)));const _22dd46b7=()=>interopDefault(__webpack_require__.e(/* import() | pages/blog/blog-right-sidebar */ 64).then(__webpack_require__.bind(null, 109)));const _3e777663=()=>interopDefault(__webpack_require__.e(/* import() | pages/blog/blog-without-sidebar */ 65).then(__webpack_require__.bind(null, 110)));const _2735f501=()=>interopDefault(__webpack_require__.e(/* import() | pages/product/product-detail/_slug */ 73).then(__webpack_require__.bind(null, 111)));const _0ac81063=()=>interopDefault(__webpack_require__.e(/* import() | pages/blog/_slug */ 63).then(__webpack_require__.bind(null, 112)));const _44b62766=()=>interopDefault(__webpack_require__.e(/* import() | pages/index */ 71).then(__webpack_require__.bind(null, 113)));const emptyFn=()=>{};external_vue_default.a.use(external_vue_router_default.a);const routerOptions={mode:'history',base:'/',linkActiveClass:'nuxt-link-active',linkExactActiveClass:'nuxt-link-exact-active',scrollBehavior: router_scrollBehavior,routes:[{path:"/blog",component:_0c7eb1ab,name:"blog"},{path:"/cart",component:_618ee916,name:"cart"},{path:"/checkout",component:_41acb41b,name:"checkout"},{path:"/confirmation",component:_6128fd0a,name:"confirmation"},{path:"/contact",component:_0d28b84a,name:"contact"},{path:"/my-account",component:_11bf70be,name:"my-account"},{path:"/shop",component:_8b7fdf6a,name:"shop"},{path:"/shop-new",component:_568cbb9e,name:"shop-new"},{path:"/blog/blog-right-sidebar",component:_22dd46b7,name:"blog-blog-right-sidebar"},{path:"/blog/blog-without-sidebar",component:_3e777663,name:"blog-blog-without-sidebar"},{path:"/product/product-detail/:slug?",component:_2735f501,name:"product-product-detail-slug"},{path:"/blog/:slug",component:_0ac81063,name:"blog-slug"},{path:"/",component:_44b62766,name:"index"}],fallback:false};function createRouter(ssrContext,config){const base=config._app&&config._app.basePath||routerOptions.base;const router=new external_vue_router_default.a({...routerOptions,base});// TODO: remove in Nuxt 3
...
/* nuxt-component-imports */
installComponents(HomeSidebarMenu_component, {HomeSidebarMenu: __webpack_require__(32).default})
...
external_vue_default.a.use(external_vuex_default.a);let store_store={};(function updateModules(){store_store=normalizeRoot(__webpack_require__(29),'store/index.js');// If store is an exported method = classic mode (deprecated)
...
const Breadcrumb=()=>__webpack_require__.e(/* import() | components/breadcrumb */ 15).then(__webpack_require__.bind(null, 56)).then(c=>wrapFunctional(c.default||c));const ContactInfo=()=>__webpack_require__.e(/* import() | components/contact-info */ 16).then(__webpack_require__.bind(null, 85)).then(c=>wrapFunctional(c.default||c));const DealWithCountdown=()=>__webpack_require__.e(/* import() | components/deal-with-countdown */ 17).then(__webpack_require__.bind(null, 114)).then(c=>wrapFunctional(c.default||c));const DealWithCountdownTwo=()=>__webpack_require__.e(/* import() | components/deal-with-countdown-two */ 18).then(__webpack_require__.bind(null, 82)).then(c=>wrapFunctional(c.default||c));const Facebook=()=>__webpack_require__.e(/* import() | components/facebook */ 19).then(__webpack_require__.bind(null, 83)).then(c=>wrapFunctional(c.default||c));const FacebookChatbox=()=>__webpack_require__.e(/* import() | components/facebook-chatbox */ 2).then(__webpack_require__.bind(null, 115)).then(c=>wrapFunctional(c.default||c));const FooterStyleTwo=()=>__webpack_require__.e(/* import() | components/footer-style-two */ 20).then(__webpack_require__.bind(null, 116)).then(c=>wrapFunctional(c.default||c));const FormPage=()=>__webpack_require__.e(/* import() | components/form-page */ 21).then(__webpack_require__.bind(null, 80)).then(c=>wrapFunctional(c.default||c));const HeaderLogoCenterWithTransparent=()=>__webpack_require__.e(/* import() | components/header-logo-center-with-transparent */ 22).then(__webpack_require__.bind(null, 117)).then(c=>wrapFunctional(c.default||c));const HeaderOffcanvasMenuWithTransparent=()=>__webpack_require__.e(/* import() | components/header-offcanvas-menu-with-transparent */ 23).then(__webpack_require__.bind(null, 118)).then(c=>wrapFunctional(c.default||c));const HeaderWithTopbar=()=>__webpack_require__.e(/* import() | components/header-with-topbar */ 25).then(__webpack_require__.bind(null, 53)).then(c=>wrapFunctional(c.default||c));const HeaderWithTopBarTwo=()=>__webpack_require__.e(/* import() | components/header-with-top-bar-two */ 24).then(__webpack_require__.bind(null, 119)).then(c=>wrapFunctional(c.default||c));const components_HomeSidebarMenu=()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 32)).then(c=>wrapFunctional(c.default||c));const Login=()=>__webpack_require__.e(/* import() | components/login */ 28).then(__webpack_require__.bind(null, 156)).then(c=>wrapFunctional(c.default||c));const MiniCart=()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 19)).then(c=>wrapFunctional(c.default||c));const Navigation=()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 21)).then(c=>wrapFunctional(c.default||c));const OffCanvasMobileMenu=()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 20)).then(c=>wrapFunctional(c.default||c));const ProductPaymentTimer=()=>__webpack_require__.e(/* import() | components/product-payment-timer */ 39).then(__webpack_require__.bind(null, 67)).then(c=>wrapFunctional(c.default||c));const QuickView=()=>__webpack_require__.e(/* import() | components/quick-view */ 49).then(__webpack_require__.bind(null, 57)).then(c=>wrapFunctional(c.default||c));const ResponsiveMobileMenu=()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 33)).then(c=>wrapFunctional(c.default||c));const ShopSidebar=()=>__webpack_require__.e(/* import() | components/shop-sidebar */ 50).then(__webpack_require__.bind(null, 73)).then(c=>wrapFunctional(c.default||c));const TheFooter=()=>__webpack_require__.e(/* import() | components/the-footer */ 51).then(__webpack_require__.bind(null, 54)).then(c=>wrapFunctional(c.default||c));const TheHeader=()=>__webpack_require__.e(/* import() | components/the-header */ 52).then(__webpack_require__.bind(null, 120)).then(c=>wrapFunctional(c.default||c));const BannerItem=()=>__webpack_require__.e(/* import() | components/banner-item */ 8).then(__webpack_require__.bind(null, 62)).then(c=>wrapFunctional(c.default||c));const BannerStyleFive=()=>__webpack_require__.e(/* import() | components/banner-style-five */ 9).then(__webpack_require__.bind(null, 86)).then(c=>wrapFunctional(c.default||c));const BannerStyleFour=()=>__webpack_require__.e(/* import() | components/banner-style-four */ 10).then(__webpack_require__.bind(null, 121)).then(c=>wrapFunctional(c.default||c));const BannerStyleOne=()=>__webpack_require__.e(/* import() | components/banner-style-one */ 11).then(__webpack_require__.bind(null, 122)).then(c=>wrapFunctional(c.default||c));const BannerStyleSix=()=>__webpack_require__.e(/* import() | components/banner-style-six */ 12).then(__webpack_require__.bind(null, 157)).then(c=>wrapFunctional(c.default||c));const BannerStyleThree=()=>__webpack_require__.e(/* import() | components/banner-style-three */ 13).then(__webpack_require__.bind(null, 158)).then(c=>wrapFunctional(c.default||c));const BannerStyleTwo=()=>__webpack_require__.e(/* import() | components/banner-style-two */ 14).then(__webpack_require__.bind(null, 123)).then(c=>wrapFunctional(c.default||c));const HeroSlider=()=>__webpack_require__.e(/* import() | components/hero-slider */ 26).then(__webpack_require__.bind(null, 124)).then(c=>wrapFunctional(c.default||c));const HeroSliderTsotan=()=>__webpack_require__.e(/* import() | components/hero-slider-tsotan */ 27).then(__webpack_require__.bind(null, 81)).then(c=>wrapFunctional(c.default||c));const ProductDetailsWrapper=()=>__webpack_require__.e(/* import() | components/product-details-wrapper */ 34).then(__webpack_require__.bind(null, 125)).then(c=>wrapFunctional(c.default||c));const ProductGridItem=()=>__webpack_require__.e(/* import() | components/product-grid-item */ 35).then(__webpack_require__.bind(null, 61)).then(c=>wrapFunctional(c.default||c));const ProductGridItemTwo=()=>__webpack_require__.e(/* import() | components/product-grid-item-two */ 36).then(__webpack_require__.bind(null, 58)).then(c=>wrapFunctional(c.default||c));const ProductGridStyleThree=()=>__webpack_require__.e(/* import() | components/product-grid-style-three */ 37).then(__webpack_require__.bind(null, 84)).then(c=>wrapFunctional(c.default||c));const ProductNewWrapper=()=>__webpack_require__.e(/* import() | components/product-new-wrapper */ 38).then(__webpack_require__.bind(null, 126)).then(c=>wrapFunctional(c.default||c));const ProductWrapper=()=>__webpack_require__.e(/* import() | components/product-wrapper */ 40).then(__webpack_require__.bind(null, 127)).then(c=>wrapFunctional(c.default||c));const ProductWrapperBooks=()=>__webpack_require__.e(/* import() | components/product-wrapper-books */ 41).then(__webpack_require__.bind(null, 128)).then(c=>wrapFunctional(c.default||c));const ProductWrapperCosmetics=()=>__webpack_require__.e(/* import() | components/product-wrapper-cosmetics */ 42).then(__webpack_require__.bind(null, 129)).then(c=>wrapFunctional(c.default||c));const ProductWrapperFive=()=>__webpack_require__.e(/* import() | components/product-wrapper-five */ 43).then(__webpack_require__.bind(null, 130)).then(c=>wrapFunctional(c.default||c));const ProductWrapperFour=()=>__webpack_require__.e(/* import() | components/product-wrapper-four */ 44).then(__webpack_require__.bind(null, 131)).then(c=>wrapFunctional(c.default||c));const ProductWrapperSeven=()=>__webpack_require__.e(/* import() | components/product-wrapper-seven */ 45).then(__webpack_require__.bind(null, 132)).then(c=>wrapFunctional(c.default||c));const ProductWrapperThree=()=>__webpack_require__.e(/* import() | components/product-wrapper-three */ 46).then(__webpack_require__.bind(null, 133)).then(c=>wrapFunctional(c.default||c));const ProductWrapperTsotan=()=>__webpack_require__.e(/* import() | components/product-wrapper-tsotan */ 47).then(__webpack_require__.bind(null, 134)).then(c=>wrapFunctional(c.default||c));const ProductWrapperTwo=()=>__webpack_require__.e(/* import() | components/product-wrapper-two */ 48).then(__webpack_require__.bind(null, 135)).then(c=>wrapFunctional(c.default||c));const PolicyServicePolicy=()=>__webpack_require__.e(/* import() | components/policy-service-policy */ 29).then(__webpack_require__.bind(null, 136)).then(c=>wrapFunctional(c.default||c));const PolicyServicePolicyFive=()=>__webpack_require__.e(/* import() | components/policy-service-policy-five */ 30).then(__webpack_require__.bind(null, 137)).then(c=>wrapFunctional(c.default||c));const PolicyServicePolicyFour=()=>__webpack_require__.e(/* import() | components/policy-service-policy-four */ 31).then(__webpack_require__.bind(null, 138)).then(c=>wrapFunctional(c.default||c));const PolicyServicePolicyThree=()=>__webpack_require__.e(/* import() | components/policy-service-policy-three */ 32).then(__webpack_require__.bind(null, 139)).then(c=>wrapFunctional(c.default||c));const PolicyServicePolicyTwo=()=>__webpack_require__.e(/* import() | components/policy-service-policy-two */ 33).then(__webpack_require__.bind(null, 140)).then(c=>wrapFunctional(c.default||c));const UnusedAboutMission=()=>__webpack_require__.e(/* import() | components/unused-about-mission */ 53).then(__webpack_require__.bind(null, 141)).then(c=>wrapFunctional(c.default||c));const UnusedAd=()=>__webpack_require__.e(/* import() | components/unused-ad */ 3).then(__webpack_require__.bind(null, 142)).then(c=>wrapFunctional(c.default||c));const UnusedBlogItem=()=>__webpack_require__.e(/* import() | components/unused-blog-item */ 4).then(__webpack_require__.bind(null, 143)).then(c=>wrapFunctional(c.default||c));const UnusedBlogItemStyleTwo=()=>__webpack_require__.e(/* import() | components/unused-blog-item-style-two */ 0).then(__webpack_require__.bind(null, 144)).then(c=>wrapFunctional(c.default||c));const UnusedBlogSidebar=()=>__webpack_require__.e(/* import() | components/unused-blog-sidebar */ 1).then(__webpack_require__.bind(null, 145)).then(c=>wrapFunctional(c.default||c));const UnusedBlogWrapper=()=>__webpack_require__.e(/* import() | components/unused-blog-wrapper */ 5).then(__webpack_require__.bind(null, 146)).then(c=>wrapFunctional(c.default||c));const UnusedBrandLogoCarousel=()=>__webpack_require__.e(/* import() | components/unused-brand-logo-carousel */ 6).then(__webpack_require__.bind(null, 147)).then(c=>wrapFunctional(c.default||c));const UnusedFunFact=()=>__webpack_require__.e(/* import() | components/unused-fun-fact */ 54).then(__webpack_require__.bind(null, 148)).then(c=>wrapFunctional(c.default||c));const UnusedInstagramPostWrapper=()=>__webpack_require__.e(/* import() | components/unused-instagram-post-wrapper */ 55).then(__webpack_require__.bind(null, 149)).then(c=>wrapFunctional(c.default||c));const UnusedNewsletterStyleOne=()=>__webpack_require__.e(/* import() | components/unused-newsletter-style-one */ 56).then(__webpack_require__.bind(null, 150)).then(c=>wrapFunctional(c.default||c));const UnusedProductDetailsDescriptionReview=()=>__webpack_require__.e(/* import() | components/unused-product-details-description-review */ 57).then(__webpack_require__.bind(null, 151)).then(c=>wrapFunctional(c.default||c));const UnusedRegister=()=>__webpack_require__.e(/* import() | components/unused-register */ 58).then(__webpack_require__.bind(null, 159)).then(c=>wrapFunctional(c.default||c));const UnusedSectionTitleWithSubTitle=()=>__webpack_require__.e(/* import() | components/unused-section-title-with-sub-title */ 59).then(__webpack_require__.bind(null, 152)).then(c=>wrapFunctional(c.default||c));const UnusedTeamMembers=()=>__webpack_require__.e(/* import() | components/unused-team-members */ 60).then(__webpack_require__.bind(null, 153)).then(c=>wrapFunctional(c.default||c));const UnusedTestimonialOne=()=>__webpack_require__.e(/* import() | components/unused-testimonial-one */ 61).then(__webpack_require__.bind(null, 154)).then(c=>wrapFunctional(c.default||c));const UnusedWelcomeMessage=()=>__webpack_require__.e(/* import() | components/unused-welcome-message */ 62).then(__webpack_require__.bind(null, 155)).then(c=>wrapFunctional(c.default||c));// nuxt/nuxt.js#8607
