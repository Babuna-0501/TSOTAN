...
import nuxt_plugin_plugin_2f56b221 from 'nuxt_plugin_plugin_2f56b221' // Source: ./components/plugin.js (mode: 'all')
import nuxt_plugin_axios_873b7292 from 'nuxt_plugin_axios_873b7292' // Source: ./axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Tsotan ecommerce","titleTemplate":"Tsotan| %s","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_2f56b221 === 'function') {
    await nuxt_plugin_plugin_2f56b221(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_873b7292 === 'function') {
    await nuxt_plugin_axios_873b7292(app.context, inject)
  }
