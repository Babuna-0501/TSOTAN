...
import nuxt_plugin_plugin_8e267edc from 'nuxt_plugin_plugin_8e267edc' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_axios_fb3a0096 from 'nuxt_plugin_axios_fb3a0096' // Source: .\\axios.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Tsotan ecommerce","titleTemplate":"Tsotan| %s","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"script":[{"src":"https:\u002F\u002Fconnect.facebook.net\u002Fen_US\u002Fsdk.js","async":true}],"style":[]},
  ...
  if (typeof nuxt_plugin_plugin_8e267edc === 'function') {
    await nuxt_plugin_plugin_8e267edc(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_fb3a0096 === 'function') {
    await nuxt_plugin_axios_fb3a0096(app.context, inject)
  }
