...
/* harmony default export */ var ProductWrapperFourvue_type_script_lang_js_ = ({components:{ProductGridStyleThree:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 66)),QuickView:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 54))},computed:{products(){return this.$store.getters.getProducts;}}});
...
installComponents(component, {ProductGridStyleThree: __webpack_require__(66).default,QuickView: __webpack_require__(54).default})
