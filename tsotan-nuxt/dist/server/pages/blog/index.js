...
/* harmony default export */ var blogvue_type_script_lang_js_ = ({components:{HeaderWithTopbar:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 51)),BlogItemStyleTwo:()=>__webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, 108)),BlogSidebar:()=>__webpack_require__.e(/* import() */ 1).then(__webpack_require__.bind(null, 109)),TheFooter:()=>Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 52))},data(){return{blogData: blog,currentPage:1,perPage:6};},computed:{getItems(){let start=(this.currentPage-1)*this.perPage;let end=this.currentPage*this.perPage;return this.blogData.slice(start,end);},getPaginateCount(){return Math.ceil(this.blogData.length/this.perPage);}},methods:{paginateClickCallback(page){this.currentPage=Number(page);}},head(){return{title:"Blog Standard"};}});
