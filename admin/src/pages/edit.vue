        ...
        <form role="form">
          ...
          <div class="form-group select_cat">
            ...
            <select
              ...
              v-model="selectedSubcategory" @change="updateSub"
                                            :disabled="!selectedCategory"
            >
              <option value="">-- Select a Subcategory --</option>
              <option
                v-for="subcategory in subcategories" :key="subcategory.name"
              >
                {{ subcategory.name }}
              </option>
            </select>
          ...
          <button class="button" @click="submitForm">Бараа засах</button>
        </form>
      </div>
    </div>
  </div>
