...
<!--                    </div>-->
                    ...
                    <tbody>
                    <tr>
                        <li v-for="product in products" :key="product.id" class="d-flex li-ct"
                            ...
                            <td class="text-md font-weight-bold mb-0" style="vertical-align: middle;">
                                {{ product.name }}
                            </td>
  ...
  export default {
    ...
    methods: {
        ...
        async fetchData() {
            axios.get(`https://api.tsotan.mn/product/list/${this.categoryId}`)
                .then(response => {
