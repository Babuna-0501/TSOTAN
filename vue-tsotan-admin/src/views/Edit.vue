...
export default {
    ...
    methods: {
        ...
        async fetchData() {
            axios.get(`http://ec2-13-250-36-132.ap-southeast-1.compute.amazonaws.com:8080/product/view/${this.id}`)
                .then(response => {
        ...
        async submitForm() {
            ...
            axios.post(`http://ec2-13-250-36-132.ap-southeast-1.compute.amazonaws.com:8080/product/update/${this.id}`, formData, {
                headers: {
